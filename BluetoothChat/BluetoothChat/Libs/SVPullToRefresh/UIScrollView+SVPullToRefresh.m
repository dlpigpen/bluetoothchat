...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        UIView *customView2 = (UIView *) customView;
        CGRect viewBounds = [customView2 bounds];
...
//                [self.activityIndicatorView stopAnimating];
        ...
        CGRect textRect = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight)
        ...
        CGRect textRect2 = [self.subtitleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight)
                                                                 options:NSStringDrawingUsesLineFragmentOrigin
                                                              attributes:@{NSFontAttributeName:self.subtitleLabel.font}
                                                                 context:nil];
        
        CGSize subtitleSize = textRect2.size;
        /*
